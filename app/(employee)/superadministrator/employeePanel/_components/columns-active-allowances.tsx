...
import { ToggleAllowanceInactive } from './allowances-toggle-dialog'

export const columnsActiveAllowances: ColumnDef<Allowance>[] = [
    {
        accessorKey: "user",
        header: ({ column }) => {
            return (
    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            return <ToggleAllowanceInactive variant='active' allowanceId={allowanceId} />
        }
    }
]