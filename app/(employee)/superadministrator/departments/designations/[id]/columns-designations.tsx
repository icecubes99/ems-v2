...
export const columns: ColumnDef<AssignDesignationWithUser>[] = [
    {
        accessorKey: "userId",
        header: ({ column }) => {
            return (
            ...
            return (
                <DropdownMenu>
                    ...
                    <div className="flex w-full flex-col gap-2 p-2">
                        ...
                        <UpdateAssignedUserForm assignedUserId={user.id} designationId={user.designationId} />
                        <RemoveUserDialog assignedUseId={user.id} />
                    </div>
                </DropdownMenu>
